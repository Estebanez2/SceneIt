...
<%@ page import="es.uma.taw.sceneit.dto.ProductionCountryDTO" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<html>
<head>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css" rel="stylesheet">
    <title>Países de producción</title>
    <style>
        .card:hover {
...
<%
    List<ProductionCountryDTO> lista = (List<ProductionCountryDTO>) request.getAttribute("productionCountry");
    request.setAttribute("pagina", "productionCountry");
%>
...
<div class="container my-5 d-flex justify-content-center">
    <div class="card shadow w-100" style="max-width: 800px;">
        <div class="card-body">
            <h1 class="card-title text-center mb-4">Lista de Países de producción</h1>

            <form:form method="post" action="/productionCountry/filtrar" modelAttribute="filtro" class="d-flex mb-4">
            ...
            <div class="table-responsive">
                <table class="table table-striped align-middle text-center">
                    ...
                    <tbody>
                    <%
                        for(ProductionCountryDTO productionCountry : lista){
                    %>
                    <tr>
                        <td><%= productionCountry.getId() %></td>
                        <td><%= productionCountry.getName() %></td>
                        <td colspan="2">
                            <div class="d-flex justify-content-center align-items-center gap-2" style="height: 100%;">
                                <form method="post" onsubmit="abrirModal(this, 'editar'); return false" class="m-0">
                                    <input type="hidden" name="id" value="<%= productionCountry.getId() %>">
            ...
            <form method="post" onsubmit="abrirModal(this, 'editar'); return false" class="text-center mt-4">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-plus-circle me-2"></i>Crear nuevo País de producción
                </button>
            </form>
        </div>
    </div>
...
<script>
    function abrirModal(form, tipo) {
        ...
        if (tipo === "editar") {
            fetch("/productionCountry/editar", {
                method: "POST",
            ...
            fetch("/productionCountry/menuBorrar", {
                method: "POST",
                body: new URLSearchParams(formData)
            })
                .then(res => res.text())
