...
<%
    List<LanguageDTO> lista = (List<LanguageDTO>) request.getAttribute("language");
    request.setAttribute("pagina", "language");
%>
...
<div class="container my-5 d-flex justify-content-center">
    <div class="card shadow w-100" style="max-width: 800px;">
        <div class="card-body">
            <h1 class="card-title text-center mb-4">Lista de idiomas</h1>

            <form:form method="post" action="/language/filtrar" modelAttribute="filtro" class="d-flex mb-4">
            ...
            <div class="table-responsive">
                <table class="table table-striped align-middle text-center">
                    ...
                    <tbody>
                    <%
                        for(LanguageDTO language : lista){
                    %>
                    <tr>
            ...
            <form method="post" onsubmit="abrirModal(this, 'editar'); return false" class="text-center mt-4">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-plus-circle me-2"></i>Crear nuevo idioma
                </button>
            </form>
        </div>
    </div>
