...
<%
    List<CastDTO> lista = (List<CastDTO>) request.getAttribute("cast");
    request.setAttribute("pagina", "cast");
%>
...
<div class="container my-5 d-flex justify-content-center">
    <div class="card shadow w-100" style="max-width: 800px;">
        <div class="card-body">
            <h1 class="card-title text-center mb-4">Lista de Casts</h1>

            <form:form method="post" action="/cast/filtrar" modelAttribute="filtro" cssClass="d-flex mb-4">

                <form:select path="tipo" cssClass="form-select me-2" style="max-width: 200px;">
                    <form:option value="personaje" label="Personaje"/>
                    <form:option value="actor" label="Actor"/>
                    <form:option value="pelicula" label="Película"/>
                </form:select>
            ...
            <form method="post" onsubmit="abrirModal(this, 'editar'); return false" class="text-center mt-4">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-plus-circle me-2"></i>Crear nuevo cast
                </button>
            </form>
        </div>
    </div>
