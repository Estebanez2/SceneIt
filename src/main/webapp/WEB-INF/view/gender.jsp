...
<%
    List<GenderDTO> lista = (List<GenderDTO>) request.getAttribute("gender");
    request.setAttribute("pagina", "gender");
%>
...
<div class="container my-5 d-flex justify-content-center">
    <div class="card shadow w-100" style="max-width: 800px;">
        <div class="card-body">
            <h1 class="card-title text-center mb-4">Lista de generos</h1>

            <form:form method="post" action="/gender/filtrar" modelAttribute="filtro" class="d-flex mb-4">
            ...
            <div class="table-responsive">
                <table class="table table-striped align-middle text-center">
                    ...
                    <tbody>
                    <%
                        for(GenderDTO gender : lista){
                    %>
                    <tr>
                        <td><%= gender.getId() %></td>
                        <td><%= gender.getName() %></td>
                        <td colspan="2">
            ...
            <form method="post" onsubmit="abrirModal(this, 'editar'); return false" class="text-center mt-4">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-plus-circle me-2"></i>Crear nuevo genero
                </button>
            </form>
        </div>
    </div>
