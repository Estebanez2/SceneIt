...
<%
    List<UserDTO> lista = (List<UserDTO>) request.getAttribute("user");
    request.setAttribute("pagina", "usuarios");
%>
...
<div class="container my-5 d-flex justify-content-center">
    <div class="card shadow w-100" style="max-width: 800px;">
        <div class="card-body">
            <h1 class="card-title text-center mb-4">Lista de usuarios</h1>

            <form:form method="post" action="/user/filtrar" modelAttribute="filtro" class="d-flex mb-4">
            ...
            <div class="table-responsive">
                <table class="table table-striped align-middle text-center">
                    ...
                    <tr>
                        ...
                        <td><%= user.getFirstName() %> <%=user.getSecondName1()%></td>
                        <td><%= user.getEmail() %></td>
                        <td><%= user.getNombreRole() %></td>
                ...
                .then(html => {
                    ...
                    if (form) {
                        form.onsubmit = function (e) {
                            const persona = document.getElementById("idRol").value.trim();
                            if (persona === "") {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        if (modal) {
            modal.addEventListener("shown.bs.modal", function () {
                ...
                if (form) {
                    form.onsubmit = function (e) {
                        const rol = document.getElementById("idRol").value.trim();
                        if (rol === "") {
                            alert("Debes seleccionar un rol.");
                            e.preventDefault();
                            return false;
