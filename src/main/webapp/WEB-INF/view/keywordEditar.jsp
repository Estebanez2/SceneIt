...
<%
  ...
  KeywordDTO keyword = (KeywordDTO) request.getAttribute("keywordDTO");
  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h3><%=(!esEditar ? "Nuevo Keyword" : "Editar Keyword")%></h3>
        <button type="button" class="btn-close" data-bs-dismiss="modal"
                aria-label="Close"></button>
      </div>

      <form:form method="post" modelAttribute="keywordDTO" action="/keyword/guardar" style="overflow-y: auto">
